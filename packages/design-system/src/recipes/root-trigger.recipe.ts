...
export const rootTriggerRecipe = cva({
  base: {
    'display': 'inline-flex',
    'alignItems': 'center',
    ...
    '&:has(> svg:only-child)': {
      paddingInline: '0.625rem !important',
    },
  ...
  variants: {
    /** Mirrors Ark example `data-variant` on the trigger node */
    tone: {
      outline: {
...
export type RootTriggerRecipeProps = RecipeProps<typeof rootTriggerRecipe>;
