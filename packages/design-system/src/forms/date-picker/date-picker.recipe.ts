...
export const datePickerRecipe = sva({
  ...
  variants: {
    size: {
      sm: {
        ...
        tableCellTrigger: { h: '7', fontSize: 'xs' },
      },
      md: {
        control: { h: '10' },
        input: { fontSize: 'sm', pl: '3', pr: '1' },
        ...
        tableCellTrigger: { h: '8', fontSize: 'sm' },
      },
      lg: {
        control: { h: '12' },
        ...
        tableCellTrigger: { h: '9', fontSize: 'md' },
      },
    },
  },
...
export type DatePickerRecipeProps = RecipeProps<typeof datePickerRecipe>;
