  ...
  variants: {
    size: {
      sm: {
        ...
        visibilityTrigger: { w: '7', h: '7' },
      },
      md: {
        control: { h: '10' },
        input: { fontSize: 'sm', pl: '3', pr: '1' },
        visibilityTrigger: { w: '8', h: '8' },
      },
      lg: {
        control: { h: '12' },
        input: { fontSize: 'md', pl: '4', pr: '1' },
        visibilityTrigger: { w: '10', h: '10' },
      },
    },
  },
...
export type InputPasswordRecipeProps = RecipeProps<typeof inputPasswordRecipe>;
