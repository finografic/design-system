...
export const semanticColorTokens = {
  bg: {
    ...
    subtle: { value: { base: '{colors.grey.xlight}', _dark: '{colors.grey.xdark}' } },
    muted: { value: { base: '{colors.grey.lighter}', _dark: '{colors.grey.darker}' } },
    emphasized: { value: { base: '{colors.grey.light}', _dark: '{colors.grey.dark}' } },
    ...
    error: { value: { base: '{colors.danger.xlight}', _dark: '{colors.danger.xdark}' } },
    warning: { value: { base: '{colors.warning.xlight}', _dark: '{colors.warning.xdark}' } },
    success: { value: { base: '{colors.success.xlight}', _dark: '{colors.success.xdark}' } },
    info: { value: { base: '{colors.info.xlight}', _dark: '{colors.info.xdark}' } },
  },
  fg: {
    DEFAULT: { value: { base: '{colors.text}', _dark: '{colors.grey.xxlight}' } },
    muted: { value: { base: 'oklch(40% 0.01 285)', _dark: 'oklch(65% 0.01 285)' } },
    subtle: { value: { base: '{colors.grey}', _dark: '{colors.grey}' } },
  ...
  border: {
    DEFAULT: { value: { base: '{colors.grey.lighter}', _dark: '{colors.grey.darker}' } },
    muted: { value: { base: '{colors.grey.xlight}', _dark: '{colors.grey.xdark}' } },
    subtle: { value: { base: '{colors.grey.xlight}', _dark: '{colors.grey.xxdark}' } },
    emphasized: { value: { base: '{colors.grey.light}', _dark: '{colors.grey.dark}' } },
    inverted: { value: { base: '{colors.text}', _dark: '{colors.grey.xlight}' } },
    error: { value: { base: '{colors.danger}', _dark: '{colors.danger.light}' } },
  ...
  accent: {
    ...
    subtle: { value: { base: '{colors.primary.xlight}', _dark: '{colors.primary.xdark}' } },
    muted: { value: { base: '{colors.primary.lighter}', _dark: '{colors.primary.darker}' } },
    emphasized: { value: { base: '{colors.primary.light}', _dark: '{colors.primary.dark}' } },
