...
declare const Select$1: {
  Root: _styled_system_jsx0.StyleContextProvider<Select.RootComponent<{}>, SlotRecipeRuntimeFn<"content" | "root" | "trigger" | "positioner" | "control" | "indicator" | "label" | "item" | "itemText" | "itemIndicator" | "itemGroup" | "itemGroupLabel" | "valueText" | "list" | "clearTrigger", {
    size: {
      sm: {
        label: {
          fontSize: "xs";
