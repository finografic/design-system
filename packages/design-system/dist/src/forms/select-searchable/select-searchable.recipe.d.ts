...
declare const selectSearchableRecipe: SlotRecipeRuntimeFn<"content" | "trigger" | "positioner" | "root" | "emptyState" | "item" | "itemText" | "itemIndicator" | "list" | "control" | "input" | "clearTrigger" | "leadIcon" | "addNew", {
  size: {
    sm: {
      control: {
        h: "9";
