...
declare const selectSearchableRecipe: SlotRecipeRuntimeFn<"input" | "content" | "root" | "emptyState" | "trigger" | "positioner" | "list" | "item" | "itemText" | "itemIndicator" | "control" | "clearTrigger" | "leadIcon" | "addNew", {
  size: {
    sm: {
      control: {
        h: "9";
