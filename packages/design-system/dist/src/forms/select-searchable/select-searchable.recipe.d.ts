...
declare const selectSearchableRecipe: SlotRecipeRuntimeFn<"content" | "root" | "trigger" | "positioner" | "control" | "item" | "itemText" | "itemIndicator" | "emptyState" | "input" | "list" | "clearTrigger" | "leadIcon" | "addNew", {
  size: {
    sm: {
      control: {
        h: "9";
