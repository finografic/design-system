...
declare const selectSearchableRecipe: SlotRecipeRuntimeFn<"content" | "trigger" | "positioner" | "root" | "control" | "input" | "item" | "itemText" | "emptyState" | "list" | "itemIndicator" | "clearTrigger" | "leadIcon" | "addNew", {
  size: {
    sm: {
      control: {
        h: "9";
