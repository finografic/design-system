...
declare const selectSearchableRecipe: SlotRecipeRuntimeFn<"root" | "positioner" | "content" | "item" | "itemText" | "itemIndicator" | "emptyState" | "trigger" | "list" | "control" | "input" | "clearTrigger" | "leadIcon" | "addNew", {
  size: {
    sm: {
      control: {
        h: "9";
