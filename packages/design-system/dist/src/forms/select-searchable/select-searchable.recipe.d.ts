...
declare const selectSearchableRecipe: SlotRecipeRuntimeFn<"input" | "content" | "positioner" | "root" | "emptyState" | "trigger" | "item" | "itemText" | "itemIndicator" | "control" | "list" | "clearTrigger" | "leadIcon" | "addNew", {
  size: {
    sm: {
      control: {
        h: "9";
