...
declare const ScrollArea$1: {
  ...
  Root: import("@styled-system/jsx").StyleContextProvider<React.ForwardRefExoticComponent<ScrollArea.RootProps & React.RefAttributes<HTMLDivElement>>, SlotRecipeRuntimeFn<"content" | "corner" | "root" | "scrollbar" | "thumb" | "viewport", SlotRecipeVariantRecord<"content" | "corner" | "root" | "scrollbar" | "thumb" | "viewport">>>;
  /** Clips the content while preserving the ability to scroll. */
  Viewport: import("@styled-system/jsx").StyleContextConsumer<React.ForwardRefExoticComponent<ScrollArea.ViewportProps & React.RefAttributes<HTMLDivElement>>>;
  /** Inner content wrapper — minimum width ensures horizontal scroll works correctly. */
  Content: import("@styled-system/jsx").StyleContextConsumer<React.ForwardRefExoticComponent<ScrollArea.ContentProps & React.RefAttributes<HTMLDivElement>>>;
  /** Custom scrollbar track — pass `orientation="vertical" | "horizontal"`. */
  Scrollbar: import("@styled-system/jsx").StyleContextConsumer<React.ForwardRefExoticComponent<ScrollArea.ScrollbarProps & React.RefAttributes<HTMLDivElement>>>;
  /** The draggable scrollbar thumb inside `Scrollbar`. */
  Thumb: import("@styled-system/jsx").StyleContextConsumer<React.ForwardRefExoticComponent<ScrollArea.ThumbProps & React.RefAttributes<HTMLDivElement>>>;
  /** Corner piece shown when both scrollbars are present. */
  Corner: import("@styled-system/jsx").StyleContextConsumer<React.ForwardRefExoticComponent<ScrollArea.CornerProps & React.RefAttributes<HTMLDivElement>>>;
};
