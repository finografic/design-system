...
//#region src/components/accordion/accordion.recipe.ts
/**
...
const accordionRecipe = sva({
	...
	variants: { size: {
		...
		lg: {
			...
			itemBody: { fontSize: "md" }
		}
	} },
	defaultVariants: { size: "md" }
});
//#endregion
export { accordionRecipe };

//# sourceMappingURL=accordion.recipe.js.map