...
declare const TreeView$1: {
  /** Root — `collection`, `selectedValue`, `onSelectionChange`, `selectionMode`, plus `size`. */Root: _$_styled_system_jsx0.StyleContextProvider<TreeView.RootComponent<{}>, SlotRecipeRuntimeFn<"root" | "item" | "itemText" | "itemIndicator" | "label" | "tree" | "branch" | "branchControl" | "branchIndicator" | "branchText" | "branchContent" | "branchIndentGuide", {
    size: {
      sm: {
        root: {
  ...
  RootProvider: _$_styled_system_jsx0.StyleContextProvider<TreeView.RootProviderComponent<{}>, SlotRecipeRuntimeFn<"root" | "item" | "itemText" | "itemIndicator" | "label" | "tree" | "branch" | "branchControl" | "branchIndicator" | "branchText" | "branchContent" | "branchIndentGuide", {
    size: {
      sm: {
        root: {
          '--tree-item-gap': "0.375rem";
