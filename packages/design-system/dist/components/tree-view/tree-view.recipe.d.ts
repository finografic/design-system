...
declare const treeViewRecipe: SlotRecipeRuntimeFn<"root" | "item" | "itemText" | "itemIndicator" | "label" | "tree" | "branch" | "branchControl" | "branchIndicator" | "branchText" | "branchContent" | "branchIndentGuide", {
  size: {
    sm: {
      root: {
