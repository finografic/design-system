...
declare const treeViewRecipe: SlotRecipeRuntimeFn<"root" | "label" | "item" | "itemIndicator" | "itemText" | "tree" | "branch" | "branchControl" | "branchIndicator" | "branchText" | "branchContent" | "branchIndentGuide", {
  size: {
    sm: {
      root: {
