...
declare const Popover$1: {
  Root: _styled_system_jsx0.StyleContextRootProvider<(props: Popover.RootProps) => react_jsx_runtime0.JSX.Element, SlotRecipeRuntimeFn<"content" | "description" | "positioner" | "arrow" | "arrowTip" | "title" | "closeTrigger" | "trigger", SlotRecipeVariantRecord<"content" | "description" | "positioner" | "arrow" | "arrowTip" | "title" | "closeTrigger" | "trigger">>>;
  RootProvider: _styled_system_jsx0.StyleContextRootProvider<(props: Popover.RootProviderProps) => react_jsx_runtime0.JSX.Element, SlotRecipeRuntimeFn<"content" | "description" | "positioner" | "arrow" | "arrowTip" | "title" | "closeTrigger" | "trigger", SlotRecipeVariantRecord<"content" | "description" | "positioner" | "arrow" | "arrowTip" | "title" | "closeTrigger" | "trigger">>>; /** Button or element that opens the popover. */
