...
declare const Popover$1: {
  Root: _$_styled_system_jsx0.StyleContextRootProvider<(props: Popover.RootProps) => _$react_jsx_runtime0.JSX.Element, SlotRecipeRuntimeFn<"content" | "trigger" | "positioner" | "arrow" | "arrowTip" | "description" | "title" | "closeTrigger", SlotRecipeVariantRecord<"content" | "trigger" | "positioner" | "arrow" | "arrowTip" | "description" | "title" | "closeTrigger">>>;
  RootProvider: _$_styled_system_jsx0.StyleContextRootProvider<(props: Popover.RootProviderProps) => _$react_jsx_runtime0.JSX.Element, SlotRecipeRuntimeFn<"content" | "trigger" | "positioner" | "arrow" | "arrowTip" | "description" | "title" | "closeTrigger", SlotRecipeVariantRecord<"content" | "trigger" | "positioner" | "arrow" | "arrowTip" | "description" | "title" | "closeTrigger">>>; /** Button or element that opens the popover. */
