...
declare const Popover$1: {
  Root: _styled_system_jsx0.StyleContextRootProvider<(props: Popover.RootProps) => react_jsx_runtime0.JSX.Element, SlotRecipeRuntimeFn<"description" | "content" | "title" | "positioner" | "closeTrigger" | "arrow" | "arrowTip" | "trigger", SlotRecipeVariantRecord<"description" | "content" | "title" | "positioner" | "closeTrigger" | "arrow" | "arrowTip" | "trigger">>>;
  RootProvider: _styled_system_jsx0.StyleContextRootProvider<(props: Popover.RootProviderProps) => react_jsx_runtime0.JSX.Element, SlotRecipeRuntimeFn<"description" | "content" | "title" | "positioner" | "closeTrigger" | "arrow" | "arrowTip" | "trigger", SlotRecipeVariantRecord<"description" | "content" | "title" | "positioner" | "closeTrigger" | "arrow" | "arrowTip" | "trigger">>>; /** Button or element that opens the popover. */
