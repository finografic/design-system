...
declare const Popover$1: {
  Root: _styled_system_jsx0.StyleContextRootProvider<(props: Popover.RootProps) => react_jsx_runtime0.JSX.Element, SlotRecipeRuntimeFn<"title" | "content" | "description" | "positioner" | "arrow" | "arrowTip" | "closeTrigger" | "trigger", SlotRecipeVariantRecord<"title" | "content" | "description" | "positioner" | "arrow" | "arrowTip" | "closeTrigger" | "trigger">>>;
  RootProvider: _styled_system_jsx0.StyleContextRootProvider<(props: Popover.RootProviderProps) => react_jsx_runtime0.JSX.Element, SlotRecipeRuntimeFn<"title" | "content" | "description" | "positioner" | "arrow" | "arrowTip" | "closeTrigger" | "trigger", SlotRecipeVariantRecord<"title" | "content" | "description" | "positioner" | "arrow" | "arrowTip" | "closeTrigger" | "trigger">>>;
