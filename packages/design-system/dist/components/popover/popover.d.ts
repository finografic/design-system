...
declare const Popover$1: {
  Root: _styled_system_jsx0.StyleContextRootProvider<(props: Popover.RootProps) => react_jsx_runtime0.JSX.Element, SlotRecipeRuntimeFn<"trigger" | "positioner" | "content" | "title" | "description" | "closeTrigger" | "arrow" | "arrowTip", SlotRecipeVariantRecord<"trigger" | "positioner" | "content" | "title" | "description" | "closeTrigger" | "arrow" | "arrowTip">>>;
  RootProvider: _styled_system_jsx0.StyleContextRootProvider<(props: Popover.RootProviderProps) => react_jsx_runtime0.JSX.Element, SlotRecipeRuntimeFn<"trigger" | "positioner" | "content" | "title" | "description" | "closeTrigger" | "arrow" | "arrowTip", SlotRecipeVariantRecord<"trigger" | "positioner" | "content" | "title" | "description" | "closeTrigger" | "arrow" | "arrowTip">>>;
