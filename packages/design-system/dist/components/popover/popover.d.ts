...
declare const Popover$1: {
  Root: _$_styled_system_jsx0.StyleContextRootProvider<(props: Popover.RootProps) => _$react_jsx_runtime0.JSX.Element, SlotRecipeRuntimeFn<"content" | "description" | "positioner" | "title" | "closeTrigger" | "arrow" | "arrowTip" | "trigger", SlotRecipeVariantRecord<"content" | "description" | "positioner" | "title" | "closeTrigger" | "arrow" | "arrowTip" | "trigger">>>;
  RootProvider: _$_styled_system_jsx0.StyleContextRootProvider<(props: Popover.RootProviderProps) => _$react_jsx_runtime0.JSX.Element, SlotRecipeRuntimeFn<"content" | "description" | "positioner" | "title" | "closeTrigger" | "arrow" | "arrowTip" | "trigger", SlotRecipeVariantRecord<"content" | "description" | "positioner" | "title" | "closeTrigger" | "arrow" | "arrowTip" | "trigger">>>; /** Button or element that opens the popover. */
