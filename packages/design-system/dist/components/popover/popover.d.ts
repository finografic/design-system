...
declare const Popover$1: {
  Root: _styled_system_jsx0.StyleContextRootProvider<(props: Popover.RootProps) => react_jsx_runtime0.JSX.Element, SlotRecipeRuntimeFn<"content" | "description" | "trigger" | "title" | "closeTrigger" | "positioner" | "arrow" | "arrowTip", SlotRecipeVariantRecord<"content" | "description" | "trigger" | "title" | "closeTrigger" | "positioner" | "arrow" | "arrowTip">>>;
  RootProvider: _styled_system_jsx0.StyleContextRootProvider<(props: Popover.RootProviderProps) => react_jsx_runtime0.JSX.Element, SlotRecipeRuntimeFn<"content" | "description" | "trigger" | "title" | "closeTrigger" | "positioner" | "arrow" | "arrowTip", SlotRecipeVariantRecord<"content" | "description" | "trigger" | "title" | "closeTrigger" | "positioner" | "arrow" | "arrowTip">>>; /** Button or element that opens the popover. */
