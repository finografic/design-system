...
declare const Tooltip$1: {
  Root: _styled_system_jsx0.StyleContextRootProvider<(props: Tooltip.RootProps) => react_jsx_runtime0.JSX.Element, SlotRecipeRuntimeFn<"trigger" | "positioner" | "content" | "arrow" | "arrowTip", SlotRecipeVariantRecord<"trigger" | "positioner" | "content" | "arrow" | "arrowTip">>>;
  RootProvider: _styled_system_jsx0.StyleContextRootProvider<(props: Tooltip.RootProviderProps) => react_jsx_runtime0.JSX.Element, SlotRecipeRuntimeFn<"trigger" | "positioner" | "content" | "arrow" | "arrowTip", SlotRecipeVariantRecord<"trigger" | "positioner" | "content" | "arrow" | "arrowTip">>>;
