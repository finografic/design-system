...
declare const Menu$1: {
  /** Root — open state, event handlers (`onSelect`, `onOpenChange`), and recipe variants. */Root: _styled_system_jsx0.StyleContextProvider<(props: Menu.RootProps) => react_jsx_runtime0.JSX.Element, SlotRecipeRuntimeFn<"content" | "root" | "item" | "itemIndicator" | "positioner" | "separator" | "itemText" | "itemGroup" | "itemGroupLabel" | "arrow" | "arrowTip" | "indicator", SlotRecipeVariantRecord<"content" | "root" | "item" | "itemIndicator" | "positioner" | "separator" | "itemText" | "itemGroup" | "itemGroupLabel" | "arrow" | "arrowTip" | "indicator">>>; /** Root with external machine state from `useMenu`. */
  RootProvider: _styled_system_jsx0.StyleContextProvider<(props: Menu.RootProviderProps) => react_jsx_runtime0.JSX.Element, SlotRecipeRuntimeFn<"content" | "root" | "item" | "itemIndicator" | "positioner" | "separator" | "itemText" | "itemGroup" | "itemGroupLabel" | "arrow" | "arrowTip" | "indicator", SlotRecipeVariantRecord<"content" | "root" | "item" | "itemIndicator" | "positioner" | "separator" | "itemText" | "itemGroup" | "itemGroupLabel" | "arrow" | "arrowTip" | "indicator">>>; /** Floating positioner — sets z-index and anchors the panel. */
