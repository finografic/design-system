...
declare const Menu$1: {
  /** Root — open state, event handlers (`onSelect`, `onOpenChange`), and recipe variants. */Root: _styled_system_jsx0.StyleContextProvider<(props: Menu.RootProps) => react_jsx_runtime0.JSX.Element, SlotRecipeRuntimeFn<"root" | "item" | "itemIndicator" | "content" | "positioner" | "indicator" | "arrow" | "arrowTip" | "itemText" | "itemGroup" | "itemGroupLabel" | "separator", SlotRecipeVariantRecord<"root" | "item" | "itemIndicator" | "content" | "positioner" | "indicator" | "arrow" | "arrowTip" | "itemText" | "itemGroup" | "itemGroupLabel" | "separator">>>; /** Root with external machine state from `useMenu`. */
  RootProvider: _styled_system_jsx0.StyleContextProvider<(props: Menu.RootProviderProps) => react_jsx_runtime0.JSX.Element, SlotRecipeRuntimeFn<"root" | "item" | "itemIndicator" | "content" | "positioner" | "indicator" | "arrow" | "arrowTip" | "itemText" | "itemGroup" | "itemGroupLabel" | "separator", SlotRecipeVariantRecord<"root" | "item" | "itemIndicator" | "content" | "positioner" | "indicator" | "arrow" | "arrowTip" | "itemText" | "itemGroup" | "itemGroupLabel" | "separator">>>; /** Floating positioner — sets z-index and anchors the panel. */
