...
declare const Menu$1: {
  /** Root — open state, event handlers (`onSelect`, `onOpenChange`), and recipe variants. */Root: _$_styled_system_jsx0.StyleContextProvider<(props: Menu.RootProps) => _$react_jsx_runtime0.JSX.Element, SlotRecipeRuntimeFn<"content" | "positioner" | "arrow" | "arrowTip" | "root" | "indicator" | "item" | "itemIndicator" | "itemText" | "itemGroup" | "itemGroupLabel" | "separator", SlotRecipeVariantRecord<"content" | "positioner" | "arrow" | "arrowTip" | "root" | "indicator" | "item" | "itemIndicator" | "itemText" | "itemGroup" | "itemGroupLabel" | "separator">>>; /** Root with external machine state from `useMenu`. */
  RootProvider: _$_styled_system_jsx0.StyleContextProvider<(props: Menu.RootProviderProps) => _$react_jsx_runtime0.JSX.Element, SlotRecipeRuntimeFn<"content" | "positioner" | "arrow" | "arrowTip" | "root" | "indicator" | "item" | "itemIndicator" | "itemText" | "itemGroup" | "itemGroupLabel" | "separator", SlotRecipeVariantRecord<"content" | "positioner" | "arrow" | "arrowTip" | "root" | "indicator" | "item" | "itemIndicator" | "itemText" | "itemGroup" | "itemGroupLabel" | "separator">>>; /** Floating positioner — sets z-index and anchors the panel. */
