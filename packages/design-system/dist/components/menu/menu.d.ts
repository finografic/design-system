...
declare const Menu$1: {
  /** Root — open state, event handlers (`onSelect`, `onOpenChange`), and recipe variants. */Root: _styled_system_jsx0.StyleContextProvider<(props: Menu.RootProps) => react_jsx_runtime0.JSX.Element, SlotRecipeRuntimeFn<"root" | "item" | "itemText" | "indicator" | "content" | "itemIndicator" | "positioner" | "separator" | "itemGroup" | "itemGroupLabel" | "arrow" | "arrowTip", SlotRecipeVariantRecord<"root" | "item" | "itemText" | "indicator" | "content" | "itemIndicator" | "positioner" | "separator" | "itemGroup" | "itemGroupLabel" | "arrow" | "arrowTip">>>; /** Root with external machine state from `useMenu`. */
  RootProvider: _styled_system_jsx0.StyleContextProvider<(props: Menu.RootProviderProps) => react_jsx_runtime0.JSX.Element, SlotRecipeRuntimeFn<"root" | "item" | "itemText" | "indicator" | "content" | "itemIndicator" | "positioner" | "separator" | "itemGroup" | "itemGroupLabel" | "arrow" | "arrowTip", SlotRecipeVariantRecord<"root" | "item" | "itemText" | "indicator" | "content" | "itemIndicator" | "positioner" | "separator" | "itemGroup" | "itemGroupLabel" | "arrow" | "arrowTip">>>; /** Floating positioner — sets z-index and anchors the panel. */
