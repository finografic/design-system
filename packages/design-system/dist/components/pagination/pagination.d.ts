...
declare const Pagination$1: {
  /** Root — `count`, `pageSize`, `page`, event handlers, plus `size`. */Root: _styled_system_jsx0.StyleContextProvider<react.ForwardRefExoticComponent<Pagination.RootProps & react.RefAttributes<HTMLElement>>, SlotRecipeRuntimeFn<"trigger" | "root" | "item" | "ellipsis", {
    size: {
      sm: {
        item: {
          w: "7";
  ...
  RootProvider: _styled_system_jsx0.StyleContextProvider<react.ForwardRefExoticComponent<Pagination.RootProviderProps & react.RefAttributes<HTMLElement>>, SlotRecipeRuntimeFn<"trigger" | "root" | "item" | "ellipsis", {
    size: {
      sm: {
        item: {
          w: "7";
