...
declare const Pagination$1: {
  /** Root — `count`, `pageSize`, `page`, event handlers, plus `size`. */Root: _$_styled_system_jsx0.StyleContextProvider<_$react.ForwardRefExoticComponent<Pagination.RootProps & _$react.RefAttributes<HTMLElement>>, SlotRecipeRuntimeFn<"trigger" | "root" | "item" | "ellipsis", {
    size: {
      sm: {
        item: {
          w: "7";
  ...
  RootProvider: _$_styled_system_jsx0.StyleContextProvider<_$react.ForwardRefExoticComponent<Pagination.RootProviderProps & _$react.RefAttributes<HTMLElement>>, SlotRecipeRuntimeFn<"trigger" | "root" | "item" | "ellipsis", {
    size: {
      sm: {
        item: {
          w: "7";
