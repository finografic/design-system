...
declare const Toast$1: {
  /** Toast root — accepts `status` variant (info | success | warning | error). @default 'info' */Root: _$_styled_system_jsx0.StyleContextProvider<_$react.ForwardRefExoticComponent<Toast.RootProps & _$react.RefAttributes<HTMLDivElement>>, SlotRecipeRuntimeFn<"description" | "title" | "closeTrigger" | "root" | "actionTrigger", {
    status: {
      info: {
        root: {
          bg: "bg.info";
