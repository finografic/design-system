...
//#region src/components/splitter/splitter.recipe.ts
/**
...
const splitterRecipe = sva({
	...
	base: {
		...
		resizeTrigger: {
			...
			"&:focus": { "&::before": { background: "accent.emphasized" } },
			"&[data-dragging]": { "&::before": { background: "accent.emphasized" } },
...
//#endregion
export { splitterRecipe };

//# sourceMappingURL=splitter.recipe.js.map