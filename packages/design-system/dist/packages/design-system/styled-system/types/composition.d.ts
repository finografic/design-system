import { CompositionStyleObject } from "./system-types.js";
//#region styled-system/types/composition.d.ts
interface Token<T> {
  value: T;
  description?: string;
}
...
//#endregion
export { AnimationStyle, AnimationStyles, CompositionStyles, LayerStyle, LayerStyles, TextStyle, TextStyles };
