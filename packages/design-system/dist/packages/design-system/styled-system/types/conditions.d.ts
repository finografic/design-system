import { AnySelector, Selectors } from "./selectors.js";
//#region styled-system/types/conditions.d.ts
interface Conditions {
  ...
  "xsToXl": string;
  /** `@media screen and (min-width: 0rem) and (max-width: 95.9975rem)` */
  "xsTo2xl": string;
  /** `@media screen and (min-width: 40rem) and (max-width: 47.9975rem)` */
  "smToMd": string;
...
type Nested<P> = P & { [K in Selectors]?: Nested<P>; } & { [K in AnySelector]?: Nested<P>; } & { [K in keyof Conditions]?: Nested<P>; };
//#endregion
export { ConditionalValue, Conditions, Nested };
