...
declare const tagsInputRecipe: SlotRecipeRuntimeFn<"description" | "root" | "item" | "label" | "itemText" | "errorText" | "control" | "input" | "clearTrigger" | "itemPreview" | "itemInput" | "itemDeleteTrigger", {
  size: {
    sm: {
      label: {
        fontSize: "xs";
