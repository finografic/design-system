...
declare const tagsInputRecipe: SlotRecipeRuntimeFn<"root" | "description" | "item" | "itemText" | "control" | "label" | "errorText" | "input" | "clearTrigger" | "itemPreview" | "itemInput" | "itemDeleteTrigger", {
  size: {
    sm: {
      label: {
        fontSize: "xs";
