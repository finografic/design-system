...
declare const tagsInputRecipe: SlotRecipeRuntimeFn<"root" | "item" | "description" | "itemText" | "label" | "errorText" | "control" | "clearTrigger" | "input" | "itemPreview" | "itemInput" | "itemDeleteTrigger", {
  size: {
    sm: {
      label: {
        fontSize: "xs";
