...
declare const tagsInputRecipe: SlotRecipeRuntimeFn<"root" | "item" | "description" | "label" | "errorText" | "input" | "control" | "clearTrigger" | "itemText" | "itemPreview" | "itemInput" | "itemDeleteTrigger", {
  size: {
    sm: {
      label: {
        fontSize: "xs";
