...
declare const tagsInputRecipe: SlotRecipeRuntimeFn<"root" | "item" | "description" | "label" | "input" | "control" | "errorText" | "clearTrigger" | "itemText" | "itemPreview" | "itemInput" | "itemDeleteTrigger", {
  size: {
    sm: {
      label: {
        fontSize: "xs";
