...
declare const tagsInputRecipe: SlotRecipeRuntimeFn<"description" | "input" | "label" | "root" | "item" | "itemText" | "control" | "errorText" | "clearTrigger" | "itemPreview" | "itemInput" | "itemDeleteTrigger", {
  size: {
    sm: {
      label: {
        fontSize: "xs";
