...
declare const tagsInputRecipe: SlotRecipeRuntimeFn<"description" | "root" | "item" | "label" | "itemText" | "control" | "input" | "clearTrigger" | "errorText" | "itemPreview" | "itemInput" | "itemDeleteTrigger", {
  size: {
    sm: {
      label: {
        fontSize: "xs";
