...
declare const tagsInputRecipe: SlotRecipeRuntimeFn<"root" | "item" | "control" | "label" | "description" | "errorText" | "input" | "clearTrigger" | "itemText" | "itemPreview" | "itemInput" | "itemDeleteTrigger", {
  size: {
    sm: {
      label: {
        fontSize: "xs";
