...
declare const tagsInputRecipe: SlotRecipeRuntimeFn<"description" | "root" | "item" | "label" | "itemText" | "control" | "input" | "errorText" | "clearTrigger" | "itemPreview" | "itemInput" | "itemDeleteTrigger", {
  size: {
    sm: {
      label: {
        fontSize: "xs";
