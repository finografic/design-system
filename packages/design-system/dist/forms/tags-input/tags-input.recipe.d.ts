...
declare const tagsInputRecipe: SlotRecipeRuntimeFn<"description" | "root" | "item" | "itemText" | "label" | "control" | "errorText" | "input" | "clearTrigger" | "itemPreview" | "itemInput" | "itemDeleteTrigger", {
  size: {
    sm: {
      label: {
        fontSize: "xs";
