...
declare const tagsInputRecipe: SlotRecipeRuntimeFn<"input" | "label" | "description" | "root" | "item" | "itemText" | "control" | "errorText" | "clearTrigger" | "itemPreview" | "itemInput" | "itemDeleteTrigger", {
  size: {
    sm: {
      label: {
        fontSize: "xs";
