...
declare const tagsInputRecipe: SlotRecipeRuntimeFn<"description" | "root" | "label" | "item" | "itemText" | "control" | "errorText" | "input" | "clearTrigger" | "itemPreview" | "itemInput" | "itemDeleteTrigger", {
  size: {
    sm: {
      label: {
        fontSize: "xs";
