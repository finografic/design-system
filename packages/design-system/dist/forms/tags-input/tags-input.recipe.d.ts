...
declare const tagsInputRecipe: SlotRecipeRuntimeFn<"root" | "item" | "description" | "itemText" | "label" | "input" | "control" | "errorText" | "clearTrigger" | "itemPreview" | "itemInput" | "itemDeleteTrigger", {
  size: {
    sm: {
      label: {
        fontSize: "xs";
