...
declare const tagsInputRecipe: SlotRecipeRuntimeFn<"description" | "root" | "item" | "itemText" | "label" | "control" | "input" | "errorText" | "clearTrigger" | "itemPreview" | "itemInput" | "itemDeleteTrigger", {
  size: {
    sm: {
      label: {
        fontSize: "xs";
