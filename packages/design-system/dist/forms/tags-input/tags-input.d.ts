...
declare const TagsInput$1: {
  ...
  RootProvider: _styled_system_jsx0.StyleContextProvider<react.ForwardRefExoticComponent<TagsInput.RootProviderProps & react.RefAttributes<HTMLDivElement>>, SlotRecipeRuntimeFn<"root" | "control" | "label" | "description" | "errorText" | "item" | "input" | "clearTrigger" | "itemText" | "itemPreview" | "itemInput" | "itemDeleteTrigger", {
    size: {
      sm: {
        label: {
          fontSize: "xs";
