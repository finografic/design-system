...
declare const TagsInput$1: {
  ...
  RootProvider: _$_styled_system_jsx0.StyleContextProvider<_$react.ForwardRefExoticComponent<TagsInput.RootProviderProps & _$react.RefAttributes<HTMLDivElement>>, SlotRecipeRuntimeFn<"root" | "item" | "description" | "itemText" | "label" | "errorText" | "control" | "clearTrigger" | "input" | "itemPreview" | "itemInput" | "itemDeleteTrigger", {
    size: {
      sm: {
        label: {
          fontSize: "xs";
