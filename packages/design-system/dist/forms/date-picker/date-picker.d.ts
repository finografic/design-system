...
declare const DatePicker$1: {
  /** Root — value, handlers, locale, plus `size`. */Root: _$_styled_system_jsx0.StyleContextProvider<_$react.ForwardRefExoticComponent<DatePicker.RootProps & _$react.RefAttributes<HTMLDivElement>>, SlotRecipeRuntimeFn<"content" | "table" | "trigger" | "positioner" | "root" | "control" | "label" | "input" | "clearTrigger" | "view" | "viewControl" | "viewTrigger" | "prevTrigger" | "nextTrigger" | "rangeText" | "tableHeader" | "tableCell" | "tableCellTrigger", {
    size: {
      sm: {
        control: {
          h: "9";
