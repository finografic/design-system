...
declare const datePickerRecipe: SlotRecipeRuntimeFn<"content" | "table" | "root" | "positioner" | "trigger" | "control" | "label" | "input" | "clearTrigger" | "view" | "viewControl" | "viewTrigger" | "prevTrigger" | "nextTrigger" | "rangeText" | "tableHeader" | "tableCell" | "tableCellTrigger", {
  size: {
    sm: {
      control: {
        h: "9";
