...
declare const datePickerRecipe: SlotRecipeRuntimeFn<"root" | "content" | "table" | "trigger" | "positioner" | "control" | "label" | "input" | "view" | "clearTrigger" | "viewControl" | "viewTrigger" | "prevTrigger" | "nextTrigger" | "rangeText" | "tableHeader" | "tableCell" | "tableCellTrigger", {
  size: {
    sm: {
      control: {
        h: "9";
