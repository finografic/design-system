...
declare const datePickerRecipe: SlotRecipeRuntimeFn<"content" | "root" | "table" | "trigger" | "positioner" | "label" | "input" | "control" | "clearTrigger" | "view" | "viewControl" | "viewTrigger" | "prevTrigger" | "nextTrigger" | "rangeText" | "tableHeader" | "tableCell" | "tableCellTrigger", {
  size: {
    sm: {
      control: {
        h: "9";
