...
declare const datePickerRecipe: SlotRecipeRuntimeFn<"table" | "root" | "content" | "positioner" | "trigger" | "control" | "label" | "input" | "clearTrigger" | "view" | "viewControl" | "viewTrigger" | "prevTrigger" | "nextTrigger" | "rangeText" | "tableHeader" | "tableCell" | "tableCellTrigger", {
  size: {
    sm: {
      control: {
        h: "9";
