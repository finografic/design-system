...
declare const datePickerRecipe: SlotRecipeRuntimeFn<"content" | "root" | "table" | "positioner" | "trigger" | "label" | "input" | "control" | "clearTrigger" | "view" | "viewControl" | "viewTrigger" | "prevTrigger" | "nextTrigger" | "rangeText" | "tableHeader" | "tableCell" | "tableCellTrigger", {
  size: {
    sm: {
      control: {
        h: "9";
