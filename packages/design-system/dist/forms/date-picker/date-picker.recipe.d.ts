...
declare const datePickerRecipe: SlotRecipeRuntimeFn<"root" | "label" | "content" | "table" | "trigger" | "positioner" | "input" | "control" | "clearTrigger" | "view" | "viewControl" | "viewTrigger" | "prevTrigger" | "nextTrigger" | "rangeText" | "tableHeader" | "tableCell" | "tableCellTrigger", {
  size: {
    sm: {
      control: {
        h: "9";
