...
declare const datePickerRecipe: SlotRecipeRuntimeFn<"content" | "table" | "root" | "label" | "input" | "control" | "positioner" | "trigger" | "clearTrigger" | "view" | "viewControl" | "viewTrigger" | "prevTrigger" | "nextTrigger" | "rangeText" | "tableHeader" | "tableCell" | "tableCellTrigger", {
  size: {
    sm: {
      control: {
        h: "9";
