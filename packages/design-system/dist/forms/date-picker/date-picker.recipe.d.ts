...
declare const datePickerRecipe: SlotRecipeRuntimeFn<"content" | "table" | "trigger" | "positioner" | "root" | "control" | "label" | "input" | "clearTrigger" | "view" | "viewControl" | "viewTrigger" | "prevTrigger" | "nextTrigger" | "rangeText" | "tableHeader" | "tableCell" | "tableCellTrigger", {
  size: {
    sm: {
      control: {
        h: "9";
