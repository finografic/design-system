...
declare const selectComboboxRecipe: SlotRecipeRuntimeFn<"content" | "root" | "item" | "itemIndicator" | "label" | "input" | "control" | "positioner" | "indicators" | "trigger" | "clearTrigger" | "itemGroup" | "itemGroupLabel" | "itemText", {
  size: {
    sm: {
      control: {
        h: "9";
