...
declare const SelectCombobox: {
  /** Root — `collection`, `value`, `onValueChange`, `onInputValueChange`, plus `size`. */Root: _$_styled_system_jsx0.StyleContextProvider<Combobox.RootComponent<{}>, SlotRecipeRuntimeFn<"content" | "root" | "item" | "itemIndicator" | "label" | "input" | "control" | "positioner" | "indicators" | "trigger" | "clearTrigger" | "itemGroup" | "itemGroupLabel" | "itemText", {
    size: {
      sm: {
        control: {
          h: "9";
  ...
  RootProvider: _$_styled_system_jsx0.StyleContextProvider<Combobox.RootProviderComponent<{}>, SlotRecipeRuntimeFn<"content" | "root" | "item" | "itemIndicator" | "label" | "input" | "control" | "positioner" | "indicators" | "trigger" | "clearTrigger" | "itemGroup" | "itemGroupLabel" | "itemText", {
    size: {
      sm: {
        control: {
          h: "9";
