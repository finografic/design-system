...
declare const SelectCombobox: {
  /** Root — `collection`, `value`, `onValueChange`, `onInputValueChange`, plus `size`. */Root: _$_styled_system_jsx0.StyleContextProvider<Combobox.RootComponent<{}>, SlotRecipeRuntimeFn<"root" | "content" | "item" | "itemIndicator" | "positioner" | "itemText" | "itemGroup" | "itemGroupLabel" | "trigger" | "control" | "label" | "input" | "clearTrigger" | "indicators", {
    size: {
      sm: {
        control: {
          h: "9";
  ...
  RootProvider: _$_styled_system_jsx0.StyleContextProvider<Combobox.RootProviderComponent<{}>, SlotRecipeRuntimeFn<"root" | "content" | "item" | "itemIndicator" | "positioner" | "itemText" | "itemGroup" | "itemGroupLabel" | "trigger" | "control" | "label" | "input" | "clearTrigger" | "indicators", {
    size: {
      sm: {
        control: {
          h: "9";
