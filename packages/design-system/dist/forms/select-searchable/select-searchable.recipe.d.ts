...
declare const selectSearchableRecipe: SlotRecipeRuntimeFn<"content" | "root" | "item" | "itemIndicator" | "input" | "control" | "trigger" | "clearTrigger" | "positioner" | "itemText" | "list" | "emptyState" | "leadIcon" | "addNew", {
  size: {
    sm: {
      control: {
        h: "9";
