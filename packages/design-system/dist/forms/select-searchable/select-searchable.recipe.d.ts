...
declare const selectSearchableRecipe: SlotRecipeRuntimeFn<"content" | "root" | "item" | "itemIndicator" | "positioner" | "trigger" | "control" | "input" | "clearTrigger" | "emptyState" | "itemText" | "list" | "leadIcon" | "addNew", {
  size: {
    sm: {
      control: {
        h: "9";
