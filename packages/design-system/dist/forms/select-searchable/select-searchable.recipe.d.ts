...
declare const selectSearchableRecipe: SlotRecipeRuntimeFn<"addNew" | "clearTrigger" | "content" | "control" | "emptyState" | "input" | "item" | "itemIndicator" | "itemText" | "leadIcon" | "list" | "positioner" | "root" | "trigger", {
  size: {
    sm: {
      control: {
        h: "9";
