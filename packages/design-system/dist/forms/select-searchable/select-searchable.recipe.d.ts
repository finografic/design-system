...
declare const selectSearchableRecipe: SlotRecipeRuntimeFn<"content" | "root" | "emptyState" | "positioner" | "item" | "itemText" | "itemIndicator" | "list" | "trigger" | "control" | "input" | "clearTrigger" | "leadIcon" | "addNew", {
  size: {
    sm: {
      control: {
        h: "9";
