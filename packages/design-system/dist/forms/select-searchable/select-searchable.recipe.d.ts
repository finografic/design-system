...
declare const selectSearchableRecipe: SlotRecipeRuntimeFn<"content" | "trigger" | "positioner" | "root" | "control" | "item" | "itemIndicator" | "input" | "clearTrigger" | "emptyState" | "itemText" | "list" | "leadIcon" | "addNew", {
  size: {
    sm: {
      control: {
        h: "9";
