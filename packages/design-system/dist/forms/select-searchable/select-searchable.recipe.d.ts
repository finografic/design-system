...
declare const selectSearchableRecipe: SlotRecipeRuntimeFn<"input" | "content" | "root" | "positioner" | "item" | "itemText" | "itemIndicator" | "emptyState" | "trigger" | "list" | "control" | "clearTrigger" | "leadIcon" | "addNew", {
  size: {
    sm: {
      control: {
        h: "9";
