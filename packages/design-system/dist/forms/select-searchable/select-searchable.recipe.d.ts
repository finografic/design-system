...
declare const selectSearchableRecipe: SlotRecipeRuntimeFn<"content" | "root" | "item" | "itemIndicator" | "emptyState" | "trigger" | "positioner" | "itemText" | "control" | "input" | "clearTrigger" | "list" | "leadIcon" | "addNew", {
  size: {
    sm: {
      control: {
        h: "9";
