...
declare const selectSearchableRecipe: SlotRecipeRuntimeFn<"content" | "root" | "item" | "itemIndicator" | "emptyState" | "input" | "control" | "positioner" | "trigger" | "clearTrigger" | "itemText" | "leadIcon" | "list" | "addNew", {
  size: {
    sm: {
      control: {
        h: "9";
