...
declare const selectSearchableRecipe: SlotRecipeRuntimeFn<"content" | "root" | "positioner" | "emptyState" | "trigger" | "item" | "itemText" | "itemIndicator" | "list" | "control" | "input" | "clearTrigger" | "leadIcon" | "addNew", {
  size: {
    sm: {
      control: {
        h: "9";
