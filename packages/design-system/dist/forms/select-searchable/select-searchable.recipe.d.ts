...
declare const selectSearchableRecipe: SlotRecipeRuntimeFn<"root" | "list" | "trigger" | "content" | "item" | "itemIndicator" | "positioner" | "emptyState" | "itemText" | "control" | "input" | "clearTrigger" | "leadIcon" | "addNew", {
  size: {
    sm: {
      control: {
        h: "9";
