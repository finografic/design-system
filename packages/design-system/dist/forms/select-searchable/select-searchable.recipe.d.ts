...
declare const selectSearchableRecipe: SlotRecipeRuntimeFn<"input" | "content" | "root" | "positioner" | "item" | "itemText" | "itemIndicator" | "emptyState" | "trigger" | "control" | "list" | "clearTrigger" | "leadIcon" | "addNew", {
  size: {
    sm: {
      control: {
        h: "9";
