...
declare const selectSearchableRecipe: SlotRecipeRuntimeFn<"root" | "item" | "itemText" | "content" | "itemIndicator" | "list" | "trigger" | "emptyState" | "positioner" | "input" | "control" | "clearTrigger" | "leadIcon" | "addNew", {
  size: {
    sm: {
      control: {
        h: "9";
