...
declare const selectSearchableRecipe: SlotRecipeRuntimeFn<"root" | "item" | "itemIndicator" | "content" | "trigger" | "positioner" | "control" | "input" | "clearTrigger" | "itemText" | "list" | "emptyState" | "leadIcon" | "addNew", {
  size: {
    sm: {
      control: {
        h: "9";
