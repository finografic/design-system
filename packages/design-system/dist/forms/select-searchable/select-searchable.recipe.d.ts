...
declare const selectSearchableRecipe: SlotRecipeRuntimeFn<"content" | "positioner" | "root" | "emptyState" | "trigger" | "item" | "itemText" | "itemIndicator" | "list" | "input" | "control" | "clearTrigger" | "leadIcon" | "addNew", {
  size: {
    sm: {
      control: {
        h: "9";
