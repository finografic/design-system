...
declare const selectSearchableRecipe: SlotRecipeRuntimeFn<"content" | "root" | "list" | "trigger" | "item" | "itemText" | "positioner" | "itemIndicator" | "control" | "input" | "clearTrigger" | "emptyState" | "leadIcon" | "addNew", {
  size: {
    sm: {
      control: {
        h: "9";
