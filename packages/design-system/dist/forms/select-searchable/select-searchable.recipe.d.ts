...
declare const selectSearchableRecipe: SlotRecipeRuntimeFn<"input" | "content" | "root" | "item" | "itemIndicator" | "emptyState" | "positioner" | "itemText" | "trigger" | "list" | "control" | "clearTrigger" | "leadIcon" | "addNew", {
  size: {
    sm: {
      control: {
        h: "9";
