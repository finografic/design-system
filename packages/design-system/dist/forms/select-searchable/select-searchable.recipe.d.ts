...
declare const selectSearchableRecipe: SlotRecipeRuntimeFn<"root" | "item" | "itemIndicator" | "content" | "emptyState" | "positioner" | "itemText" | "trigger" | "list" | "control" | "clearTrigger" | "input" | "leadIcon" | "addNew", {
  size: {
    sm: {
      control: {
        h: "9";
