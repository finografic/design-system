...
declare const selectSearchableRecipe: SlotRecipeRuntimeFn<"content" | "trigger" | "positioner" | "root" | "control" | "item" | "itemIndicator" | "input" | "clearTrigger" | "itemText" | "emptyState" | "list" | "leadIcon" | "addNew", {
  size: {
    sm: {
      control: {
        h: "9";
