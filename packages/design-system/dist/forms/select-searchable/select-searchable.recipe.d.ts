...
declare const selectSearchableRecipe: SlotRecipeRuntimeFn<"root" | "item" | "itemIndicator" | "content" | "emptyState" | "positioner" | "itemText" | "trigger" | "control" | "list" | "clearTrigger" | "input" | "leadIcon" | "addNew", {
  size: {
    sm: {
      control: {
        h: "9";
