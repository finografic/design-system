...
declare const selectSearchableRecipe: SlotRecipeRuntimeFn<"content" | "root" | "item" | "itemIndicator" | "trigger" | "positioner" | "itemText" | "list" | "input" | "control" | "clearTrigger" | "emptyState" | "leadIcon" | "addNew", {
  size: {
    sm: {
      control: {
        h: "9";
