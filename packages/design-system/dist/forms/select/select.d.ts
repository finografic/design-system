...
declare const Select$1: {
  ...
  }, "ref"> & react.RefAttributes<HTMLDivElement>>, SlotRecipeRuntimeFn<"root" | "item" | "itemIndicator" | "content" | "positioner" | "label" | "itemText" | "indicator" | "itemGroup" | "itemGroupLabel" | "trigger" | "list" | "control" | "clearTrigger" | "valueText", {
    size: {
      sm: {
        label: {
          fontSize: "xs";
  ...
  RootProvider: _styled_system_jsx0.StyleContextProvider<Select.RootProviderComponent<{}>, SlotRecipeRuntimeFn<"root" | "item" | "itemIndicator" | "content" | "positioner" | "label" | "itemText" | "indicator" | "itemGroup" | "itemGroupLabel" | "trigger" | "list" | "control" | "clearTrigger" | "valueText", {
    size: {
      sm: {
        label: {
          fontSize: "xs";
