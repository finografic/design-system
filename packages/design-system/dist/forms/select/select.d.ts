...
declare const Select$1: {
  ...
  RootProvider: _$_styled_system_jsx0.StyleContextProvider<Select.RootProviderComponent<{}>, SlotRecipeRuntimeFn<"root" | "item" | "itemIndicator" | "content" | "trigger" | "positioner" | "control" | "indicator" | "label" | "clearTrigger" | "itemText" | "list" | "itemGroup" | "itemGroupLabel" | "valueText", {
    size: {
      sm: {
        label: {
          fontSize: "xs";
