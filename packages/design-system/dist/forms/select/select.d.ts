...
declare const Select$1: {
  ...
  RootProvider: _$_styled_system_jsx0.StyleContextProvider<Select.RootProviderComponent<{}>, SlotRecipeRuntimeFn<"content" | "root" | "item" | "itemIndicator" | "positioner" | "indicator" | "trigger" | "control" | "label" | "clearTrigger" | "itemText" | "itemGroup" | "itemGroupLabel" | "valueText" | "list", {
    size: {
      sm: {
        label: {
          fontSize: "xs";
