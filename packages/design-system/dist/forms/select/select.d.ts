...
declare const Select$1: {
  ...
  }, "ref"> & react.RefAttributes<HTMLDivElement>>, SlotRecipeRuntimeFn<"content" | "trigger" | "positioner" | "root" | "control" | "indicator" | "label" | "item" | "itemIndicator" | "clearTrigger" | "itemText" | "itemGroup" | "itemGroupLabel" | "list" | "valueText", {
    size: {
      sm: {
        label: {
          fontSize: "xs";
  ...
  RootProvider: _styled_system_jsx0.StyleContextProvider<Select.RootProviderComponent<{}>, SlotRecipeRuntimeFn<"content" | "trigger" | "positioner" | "root" | "control" | "indicator" | "label" | "item" | "itemIndicator" | "clearTrigger" | "itemText" | "itemGroup" | "itemGroupLabel" | "list" | "valueText", {
    size: {
      sm: {
        label: {
          fontSize: "xs";
