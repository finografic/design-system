...
declare const Select$1: {
  Root: _styled_system_jsx0.StyleContextProvider<Select.RootComponent<{}>, SlotRecipeRuntimeFn<"content" | "root" | "label" | "control" | "trigger" | "positioner" | "indicator" | "valueText" | "list" | "item" | "itemText" | "itemIndicator" | "itemGroup" | "itemGroupLabel" | "clearTrigger", {
    size: {
      sm: {
        label: {
          fontSize: "xs";
