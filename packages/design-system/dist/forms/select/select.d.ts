...
declare const Select$1: {
  ...
  }, "ref"> & react.RefAttributes<HTMLDivElement>>, SlotRecipeRuntimeFn<"root" | "label" | "item" | "itemText" | "indicator" | "content" | "itemIndicator" | "list" | "trigger" | "positioner" | "itemGroup" | "itemGroupLabel" | "control" | "clearTrigger" | "valueText", {
    size: {
      sm: {
        label: {
          fontSize: "xs";
  ...
  RootProvider: _styled_system_jsx0.StyleContextProvider<Select.RootProviderComponent<{}>, SlotRecipeRuntimeFn<"root" | "label" | "item" | "itemText" | "indicator" | "content" | "itemIndicator" | "list" | "trigger" | "positioner" | "itemGroup" | "itemGroupLabel" | "control" | "clearTrigger" | "valueText", {
    size: {
      sm: {
        label: {
          fontSize: "xs";
