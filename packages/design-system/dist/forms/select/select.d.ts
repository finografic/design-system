...
declare const Select$1: {
  ...
  RootProvider: _$_styled_system_jsx0.StyleContextProvider<Select.RootProviderComponent<{}>, SlotRecipeRuntimeFn<"root" | "content" | "item" | "itemIndicator" | "positioner" | "itemText" | "itemGroup" | "itemGroupLabel" | "indicator" | "trigger" | "control" | "label" | "list" | "clearTrigger" | "valueText", {
    size: {
      sm: {
        label: {
          fontSize: "xs";
