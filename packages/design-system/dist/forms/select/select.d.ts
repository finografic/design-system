...
declare const Select$1: {
  ...
  RootProvider: _$_styled_system_jsx0.StyleContextProvider<Select.RootProviderComponent<{}>, SlotRecipeRuntimeFn<"content" | "root" | "item" | "itemIndicator" | "trigger" | "label" | "itemText" | "indicator" | "list" | "positioner" | "itemGroup" | "itemGroupLabel" | "control" | "valueText" | "clearTrigger", {
    size: {
      sm: {
        label: {
          fontSize: "xs";
