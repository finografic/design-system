...
declare const selectRecipe: SlotRecipeRuntimeFn<"content" | "root" | "item" | "itemIndicator" | "trigger" | "label" | "itemText" | "indicator" | "list" | "positioner" | "itemGroup" | "itemGroupLabel" | "control" | "valueText" | "clearTrigger", {
  size: {
    sm: {
      label: {
        fontSize: "xs";
