...
declare const selectRecipe: SlotRecipeRuntimeFn<"root" | "item" | "itemIndicator" | "content" | "trigger" | "positioner" | "control" | "indicator" | "label" | "clearTrigger" | "itemText" | "list" | "itemGroup" | "itemGroupLabel" | "valueText", {
  size: {
    sm: {
      label: {
        fontSize: "xs";
