...
declare const selectRecipe: SlotRecipeRuntimeFn<"root" | "item" | "itemIndicator" | "content" | "positioner" | "trigger" | "label" | "itemText" | "indicator" | "control" | "list" | "itemGroup" | "itemGroupLabel" | "clearTrigger" | "valueText", {
  size: {
    sm: {
      label: {
        fontSize: "xs";
