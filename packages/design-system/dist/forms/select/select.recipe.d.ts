...
declare const selectRecipe: SlotRecipeRuntimeFn<"content" | "root" | "item" | "itemIndicator" | "positioner" | "indicator" | "trigger" | "control" | "label" | "clearTrigger" | "itemText" | "itemGroup" | "itemGroupLabel" | "valueText" | "list", {
  size: {
    sm: {
      label: {
        fontSize: "xs";
