...
declare const selectRecipe: SlotRecipeRuntimeFn<"content" | "root" | "trigger" | "positioner" | "label" | "item" | "itemText" | "indicator" | "itemIndicator" | "itemGroup" | "itemGroupLabel" | "list" | "control" | "clearTrigger" | "valueText", {
  size: {
    sm: {
      label: {
        fontSize: "xs";
