...
declare const Listbox$1: {
  /** Root — `collection`, `value`, `onValueChange`, `selectionMode`, plus `size`. */Root: _$_styled_system_jsx0.StyleContextProvider<Listbox.RootComponent<{}>, SlotRecipeRuntimeFn<"content" | "root" | "item" | "itemText" | "itemIndicator" | "itemGroup" | "itemGroupLabel" | "label", {
    size: {
      sm: {
        item: {
          px: "2";
  ...
  RootProvider: _$_styled_system_jsx0.StyleContextProvider<Listbox.RootProviderComponent<{}>, SlotRecipeRuntimeFn<"content" | "root" | "item" | "itemText" | "itemIndicator" | "itemGroup" | "itemGroupLabel" | "label", {
    size: {
      sm: {
        item: {
          px: "2";
