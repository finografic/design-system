...
declare const Editable$1: {
  ...
  RootProvider: _styled_system_jsx0.StyleContextProvider<react.ForwardRefExoticComponent<Editable.RootProviderProps & react.RefAttributes<HTMLDivElement>>, SlotRecipeRuntimeFn<"area" | "input" | "label" | "textarea" | "root" | "control" | "preview" | "editTrigger" | "submitTrigger" | "cancelTrigger", {
    size: {
      sm: {
        input: {
          h: "8";
