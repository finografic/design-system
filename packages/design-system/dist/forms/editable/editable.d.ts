...
declare const Editable$1: {
  ...
  RootProvider: _styled_system_jsx0.StyleContextProvider<react.ForwardRefExoticComponent<Editable.RootProviderProps & react.RefAttributes<HTMLDivElement>>, SlotRecipeRuntimeFn<"root" | "control" | "label" | "input" | "area" | "textarea" | "preview" | "editTrigger" | "submitTrigger" | "cancelTrigger", {
    size: {
      sm: {
        input: {
          h: "8";
