...
declare const Switch$1: {
  /** Root — controlled state, handlers, and recipe variants (`size`, `palette`). */Root: _$_styled_system_jsx0.StyleContextProvider<_$react.ForwardRefExoticComponent<Switch.RootProps & _$react.RefAttributes<HTMLLabelElement>>, SlotRecipeRuntimeFn<"root" | "description" | "thumb" | "label" | "errorText" | "control", {
    size: {
      sm: {
        control: {
          width: "8";
