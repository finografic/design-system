...
declare function InputFieldSlot({ side, interactive, className, children, ...props }: InputFieldSlotProps): import("react").JSX.Element;
...
declare const InputFieldRoot: import("react").ForwardRefExoticComponent<Omit<InputHTMLAttributes<HTMLInputElement>, "size"> & {
...
declare const InputField: {
  ...
  Root: import("react").ForwardRefExoticComponent<Omit<InputHTMLAttributes<HTMLInputElement>, "size"> & {
    size?: "lg" | "md" | "sm" | undefined;
    hasLeadingSlot?: boolean | undefined;
    hasTrailingSlot?: boolean | undefined;
  } & {
