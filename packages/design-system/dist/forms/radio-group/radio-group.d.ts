...
declare const RadioGroup$1: {
  ...
  RootProvider: _styled_system_jsx0.StyleContextProvider<react.ForwardRefExoticComponent<RadioGroup.RootProviderProps & react.RefAttributes<HTMLDivElement>>, SlotRecipeRuntimeFn<"root" | "item" | "description" | "indicator" | "label" | "errorText" | "itemText" | "itemControl" | "itemDescription", {
    size: {
      sm: {
        label: {
          fontSize: "xs";
