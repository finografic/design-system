...
declare const RadioGroup$1: {
  ...
  RootProvider: _styled_system_jsx0.StyleContextProvider<react.ForwardRefExoticComponent<RadioGroup.RootProviderProps & react.RefAttributes<HTMLDivElement>>, SlotRecipeRuntimeFn<"root" | "item" | "description" | "label" | "itemText" | "itemControl" | "indicator" | "errorText" | "itemDescription", {
    size: {
      sm: {
        label: {
          fontSize: "xs";
