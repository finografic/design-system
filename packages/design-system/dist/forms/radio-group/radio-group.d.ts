...
declare const RadioGroup$1: {
  ...
  RootProvider: _$_styled_system_jsx0.StyleContextProvider<_$react.ForwardRefExoticComponent<RadioGroup.RootProviderProps & _$react.RefAttributes<HTMLDivElement>>, SlotRecipeRuntimeFn<"description" | "root" | "item" | "label" | "itemText" | "itemControl" | "indicator" | "errorText" | "itemDescription", {
    size: {
      sm: {
        label: {
          fontSize: "xs";
