...
declare const Checkbox$1: {
  Root: _styled_system_jsx0.StyleContextProvider<react.ForwardRefExoticComponent<Checkbox.RootProps & react.RefAttributes<HTMLLabelElement>>, SlotRecipeRuntimeFn<"root" | "indicator" | "description" | "label" | "control" | "errorText", {
    size: {
      sm: {
        control: {
          width: "4";
