...
declare const fileUploadRecipe: SlotRecipeRuntimeFn<"root" | "item" | "trigger" | "itemGroup" | "label" | "itemPreview" | "itemDeleteTrigger" | "dropzone" | "dropzoneIcon" | "dropzoneContent" | "dropzoneTitle" | "dropzoneDescription" | "itemCompact" | "itemPreviewImage" | "itemName" | "itemSizeText", {
  size: {
    sm: {
      trigger: {
        px: "3";
