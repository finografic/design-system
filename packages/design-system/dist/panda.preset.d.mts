//#region ../../node_modules/.pnpm/@pandacss+types@1.12.0/node_modules/@pandacss/types/dist/csstype.d.ts
...
//#endregion
//#region ../../node_modules/.pnpm/@pandacss+types@1.12.0/node_modules/@pandacss/types/dist/selectors.d.ts
...
//#endregion
//#region ../../node_modules/.pnpm/@pandacss+types@1.12.0/node_modules/@pandacss/types/dist/conditions.d.ts
/* -----------------------------------------------------------------------------
 * Shadowed export (in CLI): DO NOT REMOVE
 * -----------------------------------------------------------------------------*/
type ConditionObjectQuery = {
  [key: string]: ConditionObjectQuery | '@slot';
};
type ConditionQuery = string | string[] | ConditionObjectQuery;
interface Conditions {
  [condition: string]: ConditionQuery;
}
interface ExtendableConditions {
...
//#endregion
//#region ../../node_modules/.pnpm/@pandacss+types@1.12.0/node_modules/@pandacss/types/dist/prop-type.d.ts
/* -----------------------------------------------------------------------------
 * Shadowed export (in CLI): DO NOT REMOVE
 * -----------------------------------------------------------------------------*/
...
//#endregion
//#region ../../node_modules/.pnpm/@pandacss+types@1.12.0/node_modules/@pandacss/types/dist/style-props.d.ts
type String$1 = string & {};
type Number$1 = number & {};
/* -----------------------------------------------------------------------------
 * Shadowed export (in CLI): DO NOT REMOVE
 * -----------------------------------------------------------------------------*/
type CssProperties$1 = PropertiesFallback<String$1 | Number$1>;
...
//#endregion
//#region ../../node_modules/.pnpm/@pandacss+types@1.12.0/node_modules/@pandacss/types/dist/composition.d.ts
interface Token$1<T> {
  value: T;
  description?: string;
}
...
type TextStyles = Recursive$1<Token$1<TextStyle>>;
/* -----------------------------------------------------------------------------
 * Layer styles
 * -----------------------------------------------------------------------------*/
...
type AnimationStyles = Recursive$1<Token$1<AnimationStyle>>;
//#endregion
//#region ../../node_modules/.pnpm/@pandacss+types@1.12.0/node_modules/@pandacss/types/dist/static-css.d.ts
...
interface CssRule extends ConditionOptions {
  /**
...
//#endregion
//#region ../../node_modules/.pnpm/@pandacss+types@1.12.0/node_modules/@pandacss/types/dist/recipe.d.ts
...
//#endregion
//#region ../../node_modules/.pnpm/@pandacss+types@1.12.0/node_modules/@pandacss/types/dist/shared.d.ts
...
//#endregion
//#region ../../node_modules/.pnpm/@pandacss+types@1.12.0/node_modules/@pandacss/types/dist/tokens.d.ts
interface Token<Value = any> {
  value: Value;
  description?: string;
  type?: string;
  deprecated?: boolean | string;
...
type RecursiveToken<C extends string, V> = V | { [K in C]: RecursiveToken<C, V>; };
interface SemanticToken<Value = string, Condition extends string = string> extends Token<RecursiveToken<Condition, Value>> {}
/* -----------------------------------------------------------------------------
 * Token data types
 * -----------------------------------------------------------------------------*/
type BorderStyle = 'dashed' | 'dotted' | 'double' | 'groove' | 'hidden' | 'inset' | 'none' | 'outset' | 'ridge' | 'solid';
interface Border {
  color: string;
  width: string | number;
  style: BorderStyle;
...
type Tokens = { [key in keyof TokenDataTypes]?: Recursive<Token<TokenDataTypes[key]>>; };
...
//#endregion
//#region ../../node_modules/.pnpm/@pandacss+types@1.12.0/node_modules/@pandacss/types/dist/pattern.d.ts
...
//#endregion
//#region ../../node_modules/.pnpm/@pandacss+types@1.12.0/node_modules/@pandacss/types/dist/theme.d.ts
...
//#endregion
//#region ../../node_modules/.pnpm/@pandacss+types@1.12.0/node_modules/@pandacss/types/dist/utility.d.ts
interface TokenFn {
  (path: string): string | undefined;
  raw: (path: string) => Token | undefined;
}
type ThemeFn = (token: (path: string) => any) => Record<string, string>;
type PropertyValues = LiteralUnion$1<TokenCategory | 'keyframes'> | string[] | {
  type: string;
...
interface TransformArgs<T = any> {
  token: TokenFn;
  raw: T;
  utils: TransformUtils;
}
type PropertyTransform = (value: any, args: TransformArgs) => NestedCssProperties | undefined;
...
type CssSemanticGroup = 'Animation' | 'Background Gradient' | 'Background' | 'Border Radius' | 'Border' | 'Color' | 'Container' | 'Display' | 'Focus Ring' | 'Effect' | 'Flex Layout' | 'Grid Layout' | 'Height' | 'Interactivity' | 'Layout' | 'List' | 'Margin' | 'Other' | 'Padding' | 'Position' | 'Scroll' | 'Shadow' | 'System' | 'Table' | 'Transform' | 'Transition' | 'Typography' | 'Visibility' | 'Width';
type UtilityConfig = { [property in LiteralUnion$1<CssProperty>]?: PropertyConfig; };
type UtilityConfigWithExtend = { [pattern in LiteralUnion$1<CssProperty>]?: PropertyConfig | UtilityConfig | undefined; };
type ExtendableUtilityConfig = UtilityConfigWithExtend & {
  extend?: UtilityConfig | undefined;
};
//#endregion
//#region ../../node_modules/.pnpm/@pandacss+types@1.12.0/node_modules/@pandacss/types/dist/config.d.ts
interface Patterns {
...
type CssPropertySyntax = '*' | '<length>' | '<number>' | '<percentage>' | '<length-percentage>' | '<color>' | '<image>' | '<url>' | '<integer>' | '<angle>' | '<time>' | '<resolution>' | '<transform-function>' | '<length> | <percentage>';
interface CssPropertyDefinition {
   ...
   */
  syntax: LiteralUnion$1<CssPropertySyntax>;
}
interface GlobalVarsDefinition {
...
interface ThemeVariant extends Pick<Theme, 'tokens' | 'semanticTokens'> {}
interface ThemeVariantsMap {
...
//# sourceMappingURL=panda.preset.d.mts.map