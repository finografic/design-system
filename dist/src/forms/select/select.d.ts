...
declare const Select$1: {
  Root: _styled_system_jsx0.StyleContextProvider<Select.RootComponent<{}>, SlotRecipeRuntimeFn<"label" | "content" | "trigger" | "positioner" | "list" | "root" | "item" | "itemText" | "itemIndicator" | "itemGroup" | "itemGroupLabel" | "indicator" | "valueText" | "control" | "clearTrigger", {
    size: {
      sm: {
        label: {
          fontSize: "xs";
