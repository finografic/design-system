...
declare const selectSearchableRecipe: SlotRecipeRuntimeFn<"input" | "content" | "trigger" | "positioner" | "list" | "root" | "item" | "itemText" | "itemIndicator" | "emptyState" | "control" | "clearTrigger" | "leadIcon" | "addNew", {
  size: {
    sm: {
      control: {
        h: "9";
