...
declare const Tabs$1: {
  Root: _styled_system_jsx0.StyleContextProvider<react.ForwardRefExoticComponent<Tabs.RootProps & react.RefAttributes<HTMLDivElement>>, SlotRecipeRuntimeFn<"content" | "trigger" | "list" | "root" | "indicator", {
    variant: {
      line: {
        list: {
  ...
  RootProvider: _styled_system_jsx0.StyleContextProvider<react.ForwardRefExoticComponent<Tabs.RootProviderProps & react.RefAttributes<HTMLDivElement>>, SlotRecipeRuntimeFn<"content" | "trigger" | "list" | "root" | "indicator", {
    variant: {
      line: {
        list: {
          borderBottomWidth: "light";
